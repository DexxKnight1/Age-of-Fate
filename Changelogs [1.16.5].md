...
### Removed
- Removed PackMenu
# [AOF-v1.6.10] - 2024.04.22
### Fixed
- Fixed Game Issue #39
### Changed
- Downgraded Overloaded to fix crash
# [AOF-v1.6.9] - 2024.04.21
### Fixed
- Fixed Game performance, Huge thanks to the ModernGamingWorld the owner of the Monumental Experience modpack
### Added
- Added Embeddium Extension
- Added Embeddium Extras
- Added Entity Texture Features
- Added FTB Ranks, should hopefully fix FTB Team invites not working
- Added Lazydnf
- Added ModernFix
...
- Added Redirector
### Changed
- Updated Forge to v36.2.42
- Updated Appleskin
- Updated Architectury API
- Updated BisectHosting Server Menu
- Updated Botany Pots
