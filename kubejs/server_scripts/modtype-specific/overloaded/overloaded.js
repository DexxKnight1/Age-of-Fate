onEvent('recipes', (event) => {
	...
	event.shaped('overloaded:hyper_item_receiver', [
			'ABA',
			'BCB',
			'ABA'
	], {
	...
	event.shaped('overloaded:hyper_item_sender', [
			'ABA',
			'CDC',
			'ABA'
	], {
	...
	event.shaped('overloaded:hyper_fluid_receiver', [
			'GHG',
			'HJH',
			'GHG'
	], {
	...
	event.shaped('overloaded:hyper_fluid_sender', [
			'ABA',
			'CDC',
			'ABA'
	], {
	...
	event.shaped('overloaded:hyper_energy_receiver', [
			'ABA',
			'BCB',
			'ABA'
	], {
	...
	event.shaped('overloaded:multi_helmet', [
			' C ',
			'ABA',
			'D D'
	], {
	...
	event.shaped('overloaded:multi_chestplate', [
			'ACA',
			'ABA',
			'DDD'
	], {
	...
	event.shaped('overloaded:multi_leggings', [
			'DBD',
			'ACA',
			'A A'
	], {
	...
	event.shaped('overloaded:multi_boots', [
			' C ',
			'A A',
			'DBD'
	], {
	...
	event.shaped('overloaded:railgun', [
			'   ',
			'AAB',
			' AA'
	], {
	...
	//	'appliedenergistics2:facade/overloaded/nether_star_block'
	
	
	//replaceInput('overloaded:nether_star_block', 'allthecompressed:nether_star_block')
